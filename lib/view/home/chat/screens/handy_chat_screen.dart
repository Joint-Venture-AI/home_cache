...
class HandyChatScreen extends StatelessWidget {
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 6.h),
                    FaqSearchBarWidget(onChanged: (value) {}),
                    SizedBox(height: 20.h),
                    _buildPopularTopicHighlighter(),
                    SizedBox(height: 20.h),
                    _buildPopularFaqSection(),
  ...
  Widget _buildPopularTopicHighlighter() {
    return Row(
      children: [
        Container(
          width: 150.w,
          ...
          decoration: BoxDecoration(
            color: AppColors.secondary.withAlpha(185),
  ...
  Widget _buildPopularFaqSection() {
    return Column(
      children: [
        PopularFaqTile(
        ...
        PopularFaqTile(
          question: 'Why is my water pressure low, and how do I fix it?',
          answer:
